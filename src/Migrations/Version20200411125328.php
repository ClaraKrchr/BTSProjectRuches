 ...
 */
final class Version20200411125328 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE capiculteur ADD id SMALLINT AUTO_INCREMENT NOT NULL, DROP id_api, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE capiculteur ADD id_api SMALLINT NOT NULL, DROP id');
